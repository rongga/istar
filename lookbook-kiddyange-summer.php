...
<body>
  <header class="header-section">
    ...
    <div class="lb-content">
          ...
          <img src="img/lookbook/kiddyange/summer/main.jpg">
    <!-- Hero Section End -->
    <div class="container" style="margin:5px;">
      <ul class="nav nav-tabs">
        <li role="presentation"><a href="lookbook-kiddyange-winter.html">KiDDYANGE Winter</a></li>
        <li role="presentation" class="active"><a href="#">KiDDYANGE Summer</a></li>
      </ul>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                    <div class="thumbnail">
                      <a href="#">
                        <img src="img/lookbook/kiddyange/summer/banner-1.png" alt="">
                        <div class="caption">
